...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <h1 class="font-italic">ADD PROPERTY</h1>
        ...
        <div>
            <label >Title : </label>
            <input  type="text" name="title" placeholder="Write a title"  require >
          ...
          <div style="position: relative; top: 4px; right: 10px ">
            <label >Location : </label>
            <input style="color:blue;" type="text" name="location" placeholder="Write a location"  require>

            
          </div>
          <div style="position: relative; top: 8px; right: -60px">
            <label >Image : </label>
            <input type="file" name="image"  require>

            
          </div>
          <div style="position: relative; top: 20px; right: 14px ">
